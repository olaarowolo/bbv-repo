                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="pbmit-slider-content">
                                        ...
                                        <div class="pbmit-button transform-bottom transform-delay-3">
                                            <a class="pbmit-btn pbmit-btn-white" href="../html-demo/contact-us.html">
            ...
            <div class="container">
                <div class="ihbox-three-bg pbmit-bg-color-secondary">
                    <div class="row align-items-center g-0">
                                ...
                                <div class="pbmit-ihbox-box d-flex align-items-center">
                                    ...
                                    <div class="pbmit-ihbox-contents">
                                        ...
                                        <div class="pbmit-heading-desc">
                                            <span class="pbmit-day">Mon to Fri :</span>
                                            <span class="pbmit-time"> 12:00 pm - 19:00 pm</span>
                                            <br>
                                            <span class="pbmit-day">Sat to Sun :</span>
                                            <span class="pbmit-time">8:00 am to 3:30 pm</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-xl-4">
                            <div class="ihbox-three-center-img">
                                <img src="{{ asset('xpm/images/home/lotus-flower.png') }}" class="img-fluid" alt="">
                            </div>
                        </div>
                        <div class="col-md-12 col-xl-4">
                            <div class="pbmit-ihbox-style-5">
                                <div class="pbmit-ihbox-headingicon d-flex align-items-center">
                                    ...
                                    <a class="pbmin-lightbox-video" target="_blank"
                                        ...
                                        <div class="pbmit-feature-wrapper-img">
                                            <div class="pbmit-ihbox-wrapper">
                                                <div class="pbmit-ihbox-icon-type-image">
                                                    <img src="{{ asset('xpm/images/bg/beauty_by_vickky.jpg') }}"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row g-0">
                    <div class="col-md-12 col-xl-6">
                        <div class="about-three-leftbox">
                            ...
                            <div class="pbmit-btn-shape-rounded">
                    ...
                    <div class="col-md-12 col-xl-6">
                        <div class="about-three-imgbox">
                            <div class="pbmit-animation-style7 about-three-img01">
                                <img src="{{ asset('xpm/images/bg/beauty_by_vickky_home1.jpg') }}" class="img-fluid"
                                    alt="">
                            </div>
                            <div class="pbmit-animation-style7 about-three-img02">
                                <img src="{{ asset('xpm/images/bg/BeautyByVickkyLounge_home2.gif') }}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row pbmit-element-column-three g-0">
                    <div class="col-md-12 col-xl-6 service-three-left-col">
                        <div class="service-three-left-inner"
                            style="background-image: url({{ asset('xpm/images/bg/beauty_by_vickky_home3.jpg') }})"></div>
                    </div>
                                        ...
                                        <div class="pbmit-service-image-wrapper d-flex">
                                            <div class="pbmit-bg-image"
                                                ...
                                                <div class="pbmit-featured-img-wrapper">
                                                    <div class="pbmit-featured-wrapper">
                                                        <img src="{{ asset('xpm/images/services/brow_service.webp') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pbmit-content-box">
                                                ...
                                                <div class="pbmit-service-description">
                                                    <p>We offer combination brows, Ombre brows, Microbladding brows, and
                                                        Microshadding brows.</p>
                                                </div>
                                                <a class="pbmit-service-btn" href="#" title="Brow">
                                    ...
                                    <div class="pbminfotech-post-item">
                                        <div class="pbmit-service-image-wrapper d-flex">
                                            <div class="pbmit-bg-image"
                                                ...
                                                <div class="pbmit-featured-img-wrapper">
                                                    <div class="pbmit-featured-wrapper">
                                                        <img src="{{ asset('xpm/images/services/touch_up_service.webp') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pbmit-content-box">
                                                ...
                                                <div class="pbmit-service-description">
                                                    <p>We offer combination touchup, Ombre touchup, Microbladding touchup,
                                                        and
                                                        Microshadding touchup.</p>
                                                </div>
                                                <a class="pbmit-service-btn" href="#" title="Touch Up">
                                                    <span class="pbmit-button-text">Book Now</span>
                                                    <svg class="pbmit-svg-arrow" xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                        width="10" height="19" viewBox="0 0 19 19"
                                    ...
                                    <div class="pbminfotech-post-item">
                                        <div class="pbmit-service-image-wrapper d-flex">
                                            <div class="pbmit-bg-image"
                                                ...
                                                <div class="pbmit-featured-img-wrapper">
                                                    <div class="pbmit-featured-wrapper">
                                                        <img src="{{ asset('xpm/images/services/eyelashes_service.webp') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pbmit-content-box">
                                                ...
                                                <a class="pbmit-service-btn" href="../html-demo/service-details.html"
                                    ...
                                    <div class="pbminfotech-post-item">
                                        <div class="pbmit-service-image-wrapper d-flex">
                                            <div class="pbmit-bg-image"
                                                ...
                                                <div class="pbmit-featured-img-wrapper">
                                                    <div class="pbmit-featured-wrapper">
                                                        <img src="{{ asset('xpm/images/services/makeup_service.jpeg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="pbminfotech-post-item">
                                        <div class="pbmit-service-image-wrapper d-flex">
                                            <div class="pbmit-bg-image"
                                                ...
                                                <div class="pbmit-featured-img-wrapper">
                                                    <div class="pbmit-featured-wrapper">
                                                        <img src="{{ asset('xpm/images/services/hair_service.jpeg') }}"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pbmit-content-box">
                                                ...
                                                <a class="pbmit-service-btn" href="#!" title="Body Massage">
                                                    <span class="pbmit-button-text">Book Now</span>
                                                    <svg class="pbmit-svg-arrow" xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                        width="10" height="19" viewBox="0 0 19 19"
